...
public:
    CMainParams()
    {
        ...
        nSubsidyHalvingInterval = 60*24*180;
...
public:
    CTestNetParams()
    {
        ...
        vAlertPubKey = ParseHex("049e73bb0c983b8507329e66494ac4ebafde51bd9333357b0656acfb27ef529ad41990171dfa217460877528395d3880a84994c8f9fa38e6e2a0bc64795a7b4a6c");
        nDefaultPort = 51474;
        ...
        genesis.nTime = 1551150001;
        genesis.nNonce = 607404;

        hashGenesisBlock = genesis.GetHash();
        //assert(hashGenesisBlock == uint256("0x00000509197e91e87a67b3ffe1a6467f73fd544e13ac3b829524d8de7b77fc85"));
