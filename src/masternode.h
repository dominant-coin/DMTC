...
#define MASTERNODE_MIN_MNP_SECONDS (10 * 120)
#define MASTERNODE_MIN_MNB_SECONDS (5 * 150)
#define MASTERNODE_PING_SECONDS (5 * 150)
#define MASTERNODE_EXPIRATION_SECONDS (120 * 150)
#define MASTERNODE_REMOVAL_SECONDS (130 * 150)
